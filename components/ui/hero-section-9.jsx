    ...
    <section className={cn('w-full overflow-hidden bg-background py-12 sm:py-24', className)}>
      <div className="container mx-auto grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
        ...
        >
          ...
          />
          <motion.div
            className="absolute bottom-0 right-1/4 h-12 w-12 rounded-lg bg-sky-200/50 dark:bg-sky-800/30"
            variants={floatingVariants}
            animate="animate"
            style={{ transitionDelay: '0.5s' }}
          />
          <motion.div
            className="absolute bottom-1/4 left-4 h-6 w-6 rounded-full bg-indigo-200/50 dark:bg-indigo-800/30"
            variants={floatingVariants}
            animate="animate"
